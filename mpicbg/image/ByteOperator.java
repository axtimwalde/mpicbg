...
public abstract class ByteOperator implements Operator 
{
	final ByteCursor cursor;
	
	ByteOperator( ByteCursor cursor )
	{
		this.cursor = cursor;
	}
	public void add( Cursor a )
	{
		for ()
	}
	
	public ByteOperator( PixelContainer pc, Interpolator ip )
	{
		super( pc, ip );
