...
public class Test
{
	...
	public static void main(String[] args)
	{
		...
		//int[] dim = new int[]{2, 2};
		FloatStream stream = new FloatStream(pixelType, dim);

		// Create some iterators for this container
		StreamIterator  i = stream.createIterator();
		StreamIteratorByDimension iDim = stream.createIteratorByDimension();
		StreamRandomAccess iRnd = stream.createRandomAccess();
