...
final public class BlockPMCC
{
	...
	final static private void sumAndSumOfSquares( final FloatProcessor fp, final double[] sum, final double[] sumOfSquares )
	{
	 ...
	 * 
	 * @TODO make a constructor for equal size fpX and fpY to save that additional loop.
	 * 
