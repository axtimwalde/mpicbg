 ...
 */
public class InteractiveVariance implements KeyListener, MouseListener, MouseMotionListener, PlugIn
{
	...
	private BlockStatistics variance;
	...
	public void run( String arg )
	{
		...
		variance = new BlockStatistics( fp );
	...
	{
		variance.variance( blockRadiusX, blockRadiusY );
	}
